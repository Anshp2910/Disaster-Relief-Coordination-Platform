      ...
      <div className="card">
        ...
        <form onSubmit={onSubmit} className="inputGrid mt">
          ...
          <div className="grid-3-responsive">
            <div>
              <label className="small label-block" htmlFor="cr-category">{t('createRequest.categoryLabel')}</label>
            ...
            <div>
              <label className="small label-block" htmlFor="cr-priority">{t('createRequest.priorityLabel')}</label>
          ...
          <div>
            <label className="small label-block" htmlFor="cr-people">{t('createRequest.peopleCountLabel')}</label>
